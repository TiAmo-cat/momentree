...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  Widget _buildPage(BuildContext context, AppThemeConfig t, HomeController hc, AppLocalizations l) {
  ...
  Widget _buildHeader(BuildContext context, AppThemeConfig t, HomeController hc, LocaleController lc, AppLocalizations l) {
    return Padding(
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Icon(Icons.settings_outlined, size: 18, color: t.textSecondary),
            ),
          ),
        ],
      ),
  ...
  Widget _buildStatsRow(AppThemeConfig t, HomeController hc, double progressPct, int maxMomentum, AppLocalizations l) {
    return Padding(
            ...
            child: ThemedCard(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.local_fire_department, size: 14, color: t.streakColor),
                  ...
                  Text(l.days, style: TextStyle(color: t.textMuted, fontSize: 10)),
                ],
              ),
            ),
          ),
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 4),
                          Text(
                            t.isVoltage ? 'MOMENTUM' : l.momentum.toUpperCase(),
                            style: TextStyle(
                              color: t.textMuted,
                              fontSize: 10,
                              letterSpacing: 1.0,
                      ...
                      Obx(() {
                        final pct = (hc.momentum.value / maxMomentum).clamp(0.0, 1.0);
                        return SizedBox(
                          height: 6,
                          child: Stack(
                            fit: StackFit.expand,
                              ...
                              if (pct > 0)
                                Align(
                                  ...
                                  child: FractionallySizedBox(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        gradient: LinearGradient(colors: t.progressFillColors),
                                        borderRadius: BorderRadius.circular(99),
                                        boxShadow: t.progressGlow != Colors.transparent
                                            ? [BoxShadow(color: t.progressGlow, blurRadius: 4)]
                                            : null,
                                      ),
                                    ),
                                  ),
  ...
  Widget _buildTreeSection(AppThemeConfig t, HomeController hc, AppLocalizations l) {
    final stageLabels = [l.stageSeedling, l.stageSapling, l.stageYoungTree, l.stageFullGrove];
    final stageDescs = [l.stageDescSeedling, l.stageDescSapling, l.stageDescYoungTree, l.stageDescFullGrove];
                ...
                children: [
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: t.dangerBg,
                          borderRadius: BorderRadius.circular(99),
                          border: Border.all(color: t.accentDanger.withOpacity(0.3)),
                        ),
                        child: Text(
                          l.withered,
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (context, child) => Transform.translate(
                      offset: isW ? Offset.zero : Offset(0, _treeFloatAnim.value),
                      child: child,
                    ),
                    child: TreeVisual(
                      stage: stage,
  ...
  Widget _buildRecoverySection(AppThemeConfig t, HomeController hc, AppLocalizations l) {
    return Padding(
                      ...
                      child: GradientButton(
                        ...
                        child: Center(
                          child: Text(l.freeRecovery,
                              style: TextStyle(color: t.btnPrimaryText, fontSize: 13)),
                        ),
                      ),
                    ),
                    const SizedBox(width: 10),
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text(l.watchAd,
                              style: TextStyle(color: t.btnSecondaryText, fontSize: 13)),
                        ),
                      ),
                    ),
                  ),
  ...
  Widget _buildCheckInSection(AppThemeConfig t, HomeController hc, AppLocalizations l) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 24),
      child: ThemedCard(
        theme: t,
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(l.heldStrongPts,
                                style: TextStyle(
                                    color: t.btnPrimaryText.withOpacity(0.8), fontSize: 11)),
                          ],
                        ),
                      ),
                    ),
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(t.isVoltage ? 'SLIPPED' : l.slipped,
                                  style: TextStyle(color: t.btnDangerText, fontSize: 13)),
                              Text(l.slippedPts,
                                  style: TextStyle(
                                      color: t.btnDangerText.withOpacity(0.7), fontSize: 11)),
                            ],
                          ),
                        ),
                      ),
  ...
  void _showRelapseDialog(HomeController hc, AppThemeConfig t, AppLocalizations l) {
  ...
  Widget _buildCravingButton(AppThemeConfig t, HomeController hc, AppLocalizations l) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 24),
      child: Column(
        children: [
          AnimatedBuilder(
            ...
            builder: (context, child) {
              final glow = t.btnCravingGlow != Colors.transparent
                  ? t.btnCravingGlow.withOpacity(0.3 + _cravingPulseAnim.value * 0.4)
                  : null;
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Icon(Icons.chevron_right, color: t.btnCravingText, size: 18),
                    ],
                  ),
                ),
              );
  ...
  Widget _buildStatsFooter(AppThemeConfig t, HomeController hc, AppLocalizations l) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 24),
      child: ThemedCard(
        theme: t,
        ...
        child: Obx(() => Row(
          ...
          children: [
            ...
            _statItemIcon(t, Icons.replay, '${hc.relapseCount.value}', l.relapses),
          ],
        )),
      ),
    );
  ...
  Widget _statItemIcon(AppThemeConfig t, IconData icon, String value, String label) {
    return Column(
      children: [
  ...
  Widget _buildAdBanner(AppThemeConfig t) {
    return Padding(
...
class _RelapseBottomSheet extends StatelessWidget {
  ...
  const _RelapseBottomSheet({required this.theme, required this.hc, required this.l});
      ...
      child: Container(
        ...
        child: GestureDetector(
          ...
          child: Container(
            width: double.infinity,
            decoration: BoxDecoration(
              color: isForest || isVoltage ? const Color(0xFF111111) : Colors.white,
              ...
              children: [
                ...
                GradientButton(
                  ...
                  onTap: () {
                    ...
                    hc.checkInSuccess();
                    Get.toNamed(AppRoutes.result, arguments: {'type': 'success', 'streakBonus': false});
                  },
                  child: Center(
                    child: Text(l.iHeldStrongToday,
                        style: TextStyle(color: t.btnPrimaryText, fontSize: 15)),
                  ),
                ),
                const SizedBox(height: 10),
                GestureDetector(
                ...
                TextButton(
                  ...
                  child: Text(l.cancel, style: TextStyle(color: t.textMuted, fontSize: 14)),
                ),
              ],
            ),
          ),
